...
namespace VRChatOSCLib
{
    public partial class VRChatOSC
    {
        ...
        public async Task SendChatboxAsync(string text, bool bypassKeyboard) => await SendToAsync(chatbox_input_address, text, bypassKeyboard);
